package com.atguigu.iceberg.flink.streaming;
...
//flink run -m yarn-cluster -ynm dimetl -p 12 -ys 4 -yjm 1024 -ytm 2048m -d -c com.atguigu.iceberg.flink.streaming.TestTopic  -yqu flink ./icberg-flink-demo-1.0-SNAPSHOT-jar-with-dependencies.jar
