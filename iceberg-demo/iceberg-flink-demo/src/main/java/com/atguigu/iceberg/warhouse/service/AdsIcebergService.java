...
import com.atguigu.iceberg.warhouse.bean.QueryResult;
import com.atguigu.iceberg.warhouse.dao.DwsIcbergDao;
...
public class AdsIcebergService {
    ...
    private DwsIcbergDao dwsIcbergDao = new DwsIcbergDao();
    ...
    public void queryDetails(StreamExecutionEnvironment env, StreamTableEnvironment tableEnv, String dt) {
        ...
        TableLoader top3Table = TableLoader.fromHadoopTable(catalogPath + "ads_register_top3memberpay");
        TableLoader appregurlnumTable = TableLoader.fromHadoopTable(catalogPath + "ads_register_appregurlnum");
